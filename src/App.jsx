  ...
  return (
    <>
      ...
      <div className="statistics">
        <h2>Statistics</h2>
        <div className="stats">All animals: {allAnimals.current}</div>
        <div className="stats">Total: {total.current}</div>
        <div className="stats">Cows: {types.current.cow}</div>
        <div className="stats">Sheeps: {types.current.sheep}</div>
        <div className="stats">Horses: {types.current.horse}</div>
